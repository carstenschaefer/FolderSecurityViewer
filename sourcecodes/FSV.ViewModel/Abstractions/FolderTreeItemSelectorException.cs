...
namespace FSV.ViewModel.Abstractions
{
    ...
    public class FolderTreeItemSelectorException : Exception
    {
        public FolderTreeItemSelectorException()
        {
        }

        public FolderTreeItemSelectorException(string message) : base(message)
        {
        }
