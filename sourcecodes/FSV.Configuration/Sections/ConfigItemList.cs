...
namespace FSV.Configuration.Sections
{
    ...
    public class ConfigItemList : Collection<ConfigItem>
    {
        private readonly XElement _parent;

        public ConfigItemList(XElement parent, Func<XElement, ConfigItem> itemCreate)
        {
            if (itemCreate == null)
            {
            ...
            {
                this.Items.Add(itemCreate(item));
            }
        }

        protected override void InsertItem(int index, ConfigItem item)
        {
            base.InsertItem(index, item);
            this._parent.Add(item.Element);
        }

        protected override void SetItem(int index, ConfigItem item)
        {
