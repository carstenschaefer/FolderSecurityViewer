...
namespace FSV.Console.Commands
{
    ...
    public class PermissionReportCommand : ICommand
    {
        ...
        public CommandOption OptionDb { get; } = new("-d|--db", CommandOptionType.NoValue) { Description = Resources.OptionDatabaseDescriptionText };

        public CommandOption OptionDifference { get; } = new("-df|--difference", CommandOptionType.NoValue) { Description = Resources.OptionPermissionSubFoldersDescriptionText };

        public CommandOption OptionDifferenceExportPath { get; } = new("-dp|--difference-path", CommandOptionType.SingleValue) { Description = Resources.OptionPermissionSubFoldersDescriptionText };

        public string CommandName => "pr";

        public string CommandDescription => Resources.PermissionReportDescription;
        ...
        private IEnumerable<CommandOption> CreateOptions()
        {
            return new[]
            {
                this.OptionExportType,
                this.OptionExportPath,
                this.OptionDb,
                this.OptionDifference,
                this.OptionDifferenceExportPath
            };
        }
