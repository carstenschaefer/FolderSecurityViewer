...
namespace FSV.Console.Commands
{
    ...
    public class UserReportCommand : ICommand
    {
        ...
        public NameArgument UserArgument { get; } = new("[user]", Resources.ArgumentUserDescriptionText);

        public string CommandName => "ur";

        public string CommandDescription => Resources.UserPermissionReportDescription;
