...
namespace FSV.Console.Commands
{
    ...
    public class OwnerReportCommand : ICommand
    {
        ...
        public NameArgument OwnerNameArgument { get; } = new("[owner]", Resources.ArgumentUserDescriptionText);

        public string CommandName => "or";

        public string CommandDescription => Resources.OwnerReportDescription;
        ...
        private IEnumerable<CommandArgument> CreateArguments()
        {
            ...
            {
                this.DirectoryArgument,
                this.OwnerNameArgument
            };
        }
    }
}