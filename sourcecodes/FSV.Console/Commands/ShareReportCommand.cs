...
namespace FSV.Console.Commands
{
    ...
    public class ShareReportCommand : ICommand
    {
        private IEnumerable<CommandArgument> arguments;
        private IEnumerable<CommandOption> options;

        public NameArgument ShareNameArgument { get; } = new("[server]", Resources.ArgumentServerDescriptionText);

        public string CommandName => "sr";

        public string CommandDescription => Resources.ShareReportDescription;
        ...
        public CommandOption OptionExportType { get; } = new("-e|--export <fileType>", CommandOptionType.SingleValue) { Description = Resources.ShareReportOptionExportDescriptionText };
        ...
        {
            return new[] { this.ShareNameArgument };
        }
    }
}