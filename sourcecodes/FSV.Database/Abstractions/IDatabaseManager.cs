...
namespace FSV.Database.Abstractions
{
    ...
    {
        /// <summary>
        ///     Initializes the manager with the currently configured database connection.
        /// </summary>
        ...
        void InitDatabase(BaseConfiguration configuration);

        BaseConfiguration GetCurrentDatabase();
    }
}