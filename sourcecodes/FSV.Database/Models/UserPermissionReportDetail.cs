...
namespace FSV.Database.Models
{
    ...
    public class UserPermissionReportDetail
    {
        [Key]
        [DatabaseGenerated(DatabaseGeneratedOption.Identity)]
        public int Id { get; set; }

        [Required] public int UserPermissionReportId { get; set; }
        ...
        public virtual UserPermissionReport UserPermissionReport { get; set; }
    }
}